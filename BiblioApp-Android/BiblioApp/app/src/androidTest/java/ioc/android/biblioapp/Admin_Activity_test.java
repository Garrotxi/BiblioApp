...
public class Admin_Activity_test {
    String usuario = null;
    ...
    @Rule
    public IntentsTestRule<Pantalla_Inicio_Administrador> intentsRule =
            new IntentsTestRule<>(Pantalla_Inicio_Administrador.class);
